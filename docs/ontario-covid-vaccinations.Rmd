...
**Latest reported number of people fully vaccinated**  
...
**Daily amounts of vaccine doses and cumulative total of vaccine doses administered**
...
ggplot() +
  ...
  scale_y_continuous(name = "Daily doses",
                     sec.axis = sec_axis(~ . * 100, name = "Cumilative total doses")) +
  theme(
