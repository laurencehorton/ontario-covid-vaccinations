...
ggplot(bar, aes(x = "", y = Percentage, fill = Status)) +
  ...
  labs(
    ...
    title = "Ontario COVID-19 vaccination status of adult population (aged 15+)",
    subtitle = Sys.Date()
  ) +
  theme_classic() +
  theme(
...
ggplot(vizfull, aes(report_date, percentage)) +
  ...
  geom_line(data = vizfullorpart, aes(linetype = "Fully or Partly")) +
  ...
  labs(
    ...
    subtitle = "Percentage of adult population (aged 15+)"
  ) +
