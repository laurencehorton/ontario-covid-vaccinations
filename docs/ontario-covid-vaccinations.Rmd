...
latestage <-
  mutate(latestage,
         At.least.one.dose_cumulative = (At.least.one.dose_cumulative - Second_dose_cumulative) * -1) # Subtract Second dose total from at least one total. Multiply by -1 to get a negative number
